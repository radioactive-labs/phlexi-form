  ...
  module Form
    class BuilderTest < Minitest::Test
      ...
      def test_initialization
        field = Builder.new(:name, parent: @parent, object: @object, **@options)
      ...
      def test_label_tag
        field = Builder.new(:name, parent: @parent, object: @object)
      ...
      def test_hint_tag
        field = Builder.new(:password, parent: @parent, object: @object, hint: "Must be at least 8 characters")
        hint = field.hint_tag
      ...
      def test_error_tag
        field = Builder.new(:email, parent: @parent, object: @object)
      ...
      def create_field_with_theme(theme)
        Builder.new(:name, parent: @parent, object: @object, theme: theme)
      end
    end
  end
end
